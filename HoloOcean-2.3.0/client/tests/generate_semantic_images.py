...
def test_semantic_camera(resolution):
    ...
    cfg["agents"][0]["sensors"][0]["sensor_type"] = "SemanticSegmentationCamera"
    ...
    with holoocean.environments.HoloOceanEnvironment(
        ...
        val = env.tick()
        pixels = val["TestCamera"][:, :, 0:3]
        filepath = str("baseline_semantic_" + str(resolution) + ".png")
...
if __name__ == "__main__":
    print("Hello")
    test_semantic_camera(256)
    test_semantic_camera(500)
    test_semantic_camera(1000)
