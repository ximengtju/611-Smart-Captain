...
def test_semantic_camera(resolution, request):
    """Makes sure that the semantic segmentation camera is positioned and capturing correctly.
    ...
    with holoocean.environments.HoloOceanEnvironment(
        ...
        filepath = str("/baseline_images/baseline_semantic_" + str(resolution) + ".png")
