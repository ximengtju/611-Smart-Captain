 ...
 * funcions. Reports whether the parent agent is currenty colliding with any
 * other object.
 */
...
public:
	 ...
	 * It's important for these things to be initialized before the its actor's
	 * BeginPlay() is called.
	 */
