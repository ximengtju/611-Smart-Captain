 ...
 * It is a placeholder for important information, and it is also used for
 * starting the server. tell their controller to open up the channels needed for
 * giving commands across the python binding.
 */
UCLASS()
