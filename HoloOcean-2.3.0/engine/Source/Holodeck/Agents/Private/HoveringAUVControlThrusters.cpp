...
UHoveringAUVControlThrusters::UHoveringAUVControlThrusters(
	const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer) {}

void UHoveringAUVControlThrusters::Execute(
	...
	if (HoveringAUV == nullptr) {
		...
		if (HoveringAUV == nullptr) {
			UE_LOG(
				...
				Error,
				TEXT(
					"UHoveringAUVControlThrusters couldn't get HoveringAUV "
					"reference"));
			return;
		}
