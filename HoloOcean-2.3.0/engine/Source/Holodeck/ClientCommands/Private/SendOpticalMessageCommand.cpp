...
void USendOpticalMessageCommand::Execute() {
	...
	verifyf(
		...
		TEXT("USendOpticalMessageCommand::Execute: Invalid Arguments"));
	...
	verifyf(
		...
		*FromSensorName,
		*FromAgentName);
	UOpticalModemSensor* FromSensor =
		(UOpticalModemSensor*)FromAgent->SensorMap[FromSensorName];
	...
	verifyf(
		...
		*ToSensorName,
		*ToAgentName);
	UOpticalModemSensor* ToSensor =
		(UOpticalModemSensor*)ToAgent->SensorMap[ToSensorName];
