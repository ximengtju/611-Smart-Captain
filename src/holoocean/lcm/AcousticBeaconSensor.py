...
class AcousticBeaconSensor(object):
    ...
    def _decode_one(buf):
        ...
        self.from_beacon, self.azimuth, self.elevation, self.range, self.z = (
            struct.unpack(">iffff", buf.read(20))
        )
        return self
    ...
    def _get_hash_recursive(parents):
        if AcousticBeaconSensor in parents:
            return 0
    ...
    def _get_packed_fingerprint():
        if AcousticBeaconSensor._packed_fingerprint is None:
            AcousticBeaconSensor._packed_fingerprint = struct.pack(
                ">Q", AcousticBeaconSensor._get_hash_recursive([])
            )
