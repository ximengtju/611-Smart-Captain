...
public:
	...
	static constexpr int TOTAL_DOF = NUM_3_AXIS_JOINTS * 3 + NUM_2_AXIS_JOINTS * 2
		+ NUM_1_AXIS_JOINTS; // 94 DOF in total
	...
	// Decal material. This is used to show collisions on the Android. It is to be
	// left blank and is set programmatically
