...
public:
	...
	static constexpr int NUM_2_PLUS_3_AXIS_JOINTS =
		NUM_3_AXIS_JOINTS + NUM_2_AXIS_JOINTS;
	static constexpr int NUM_FLOAT_DIRECTIONS = 3;
	static constexpr int TOTAL_JOINT_DOF =
		NUM_3_AXIS_JOINTS * 3 + NUM_2_AXIS_JOINTS * 2 + NUM_1_AXIS_JOINTS;
...
private:
	...
	/**
	 * ApplyLevitation
	 * Makes the HandAgent fly around. Used with the HandAgentMaxTorqueFloat
	 * control scheme
	 */
