...
AAndroidController::AAndroidController(const FObjectInitializer& ObjectInitializer)
...
void AAndroidController::OnPossess(APawn* PawnParam) {
	...
	this->ControlScheme->SetSkeletalMesh(
		this->SkeletalMeshComponent, const_cast<FName*>(AAndroid::Joints));
