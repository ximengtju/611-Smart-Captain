...
USurfaceVesselControlThrusters::USurfaceVesselControlThrusters(
	const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer) {}

void USurfaceVesselControlThrusters::Execute(
	...
	if (SurfaceVessel == nullptr) {
		...
		if (SurfaceVessel == nullptr) {
			UE_LOG(
				...
				Error,
				TEXT(
					"USurfaceVesselControlThrusters couldn't get SurfaceVessel "
					"reference"));
			return;
		}
