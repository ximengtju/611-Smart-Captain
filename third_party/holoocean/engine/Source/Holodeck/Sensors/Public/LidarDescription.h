...
USTRUCT()
struct HOLODECK_API FLidarDescription {
	GENERATED_BODY()
public:
	// Number of lasers
	...
	//  How far each of the lasers can go in centimeters
	UPROPERTY(EditAnywhere)
	...
	/// Attenuation Rate in the atmosphere in cm^-1.
	UPROPERTY(EditAnywhere)
	...
	/// Intensity value below which intensity-based-drop-off starts, between 0 and 1.
	UPROPERTY(EditAnywhere)
