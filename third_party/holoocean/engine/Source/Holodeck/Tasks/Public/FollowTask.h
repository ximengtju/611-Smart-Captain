 ...
 * the Target is less than FOVRadians and is there is nothing blocking the
 * agent's line of sight, otherwise the reward is 0. If OnlywithinSight is
 * false, the reward is set to the percent distance covered from the MinDistance
 * to the ToFollow Actor. Terminal is always false.
 */
