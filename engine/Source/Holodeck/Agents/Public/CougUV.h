...
const float CUV_MAX_THRUST = 100;
const float CUV_MIN_FIN = -45;
const float CUV_MAX_FIN = 45;

const float CUV_MAX_LIN_ACCEL = 10;
const float CUV_MAX_ANG_ACCEL = 2;
...
*/
class HOLODECK_API ACougUV : public AHolodeckBuoyantAgent
{
	GENERATED_BODY()
