...
const float AUV_MAX_LIN_ACCEL = 10; // m/s^2
const float AUV_MAX_ANG_ACCEL = 2; // rad/s^2
const float AUV_MAX_THRUST = AUV_MAX_LIN_ACCEL*31.02 / 4; // N: 31.02 is mass of vehicle, divided by 4 thrusters. 
...
public:
	...
	*/
	...
	TArray<FVector> thrusterLocations{  FVector( 18.18,  22.14, -4.00), 
									    FVector( 18.18, -22.14, -4.00),
										FVector(-31.43, -22.14, -4.00),
										FVector(-31.43,  22.14, -4.00),
