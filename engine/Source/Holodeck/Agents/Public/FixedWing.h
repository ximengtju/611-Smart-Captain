...
#include "FixedWing.generated.h"

const float FW_MAX_LIN_ACCEL = 10;
const float FW_MAX_ANG_ACCEL = 2;
const float FW_MAX_THRUST = FW_MAX_LIN_ACCEL*31.02 / 4;
...
*/
class HOLODECK_API AFixedWing : public AHolodeckBuoyantAgent
{
	GENERATED_BODY()
